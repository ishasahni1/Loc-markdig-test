...
<strong>Step 1. Download an Intune public key certificate required to create an Apple DEP token.</strong><br>
...
<strong>Step 2. Create and download an Apple DEP token.</strong><br>
